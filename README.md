...
Setup your Python virtual environment if you want to use one:
...
important as the 'Acceptance Test' stages in the CI/CD Pipelines rely on this file.

We also install dependencies and initialise pre-commit hooks within this script.

## Pipeline Resources

This template is compatible with our [Api Service Pipeline](https://github.com/chetwoodfinancial/chetwood-service-codepipelines/blob/master/pac/cloudformation/pipelines/api-pipelines/).
...
These variables ensure that nothing in the buildspec needs to be changed:
